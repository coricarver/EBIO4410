...
*Observations that are as or more extreme than 18/25 include 19/25, 20/25, 21/25, 22/25, 23/25, 24/25 and 25/25 OR 0/25, 1/25, 2/25, 3/25, 4/25, 5/25, 6/25, and 7/25. * 
...
```{r}
binom.test(18, n = 25, p = 0.05, alternative = "two.sided")
```
