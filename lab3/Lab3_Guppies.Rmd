...
*With a much smaller sample size the p-value becomes 0.4531. The p-value changes drastically despite a similar p-hat to our first observation because a smaller sample size gives us much larger confidence intervals and as sample size increases the impact stochastic error is reduced. * 
