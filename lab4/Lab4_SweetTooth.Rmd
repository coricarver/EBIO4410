...
*Null hypothesis: Students cannot identify Jelly Belly flavors better than chance.*
...
#Statistical Test Chosen: chi-squared goodness of fit test because it will compare a distribution of observed counts to a distribution of expected counts under some probability model.
...
barplot(height = beanData, beside=TRUE, cex.names = 0.8, ylim = c(0,40),
        legend = c("Observed", "Expected"), col=colors)
...
*P-value: 0.5465, Chi-squared: 0.36364* 
...
*The output of this tells us that there is a 55% chance of observing our jelly bean distribution OR jelly bean distributions even further from the null, if the null hypothesis is true. Since it is not < 0.05, we cannot reject the null hypothesis. Therefore, students cannot identify Jelly Belly flavors better than chance. *
